...
namespace Test1
{
    public partial class CustomersAndRepresentatives : Form
    {
        ...
        private void CustomersAndRepresentatives_Load(object sender, EventArgs e)
        {
            //y = 1052, 857
            //x = 1402, 515
            //this.Size = new Size(new Point(Remove.Location.X, Credit.Location.Y));
            this.AutoSize = true;
            ScalerX.Visible = false;
            ScalerY.Visible = false;
        }

        private void New_Click(object sender, EventArgs e)
        {
            NewCustomerorRep newcustorrep = new NewCustomerorRep();
            newcustorrep.Show();
        }
    }
}
